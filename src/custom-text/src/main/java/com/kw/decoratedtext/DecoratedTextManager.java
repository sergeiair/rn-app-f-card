 ...
 * whole text subtree.
 */
@ReactModule(name = DecoratedTextManager.REACT_CLASS)
public class DecoratedTextManager extends BaseViewManager<ReactTextView, ReactTextShadowNode> {

  @VisibleForTesting
  public static final String REACT_CLASS = "DecoratedText";
  ...
  @Override
  public DecoratedText createViewInstance(ThemedReactContext context) {
    return new ReactTextView(context);
  }

  // maxLines can only be set in master view (block), doesn't really make sense to set in a span
  @ReactProp(name = ViewProps.NUMBER_OF_LINES, defaultInt = ViewDefaults.NUMBER_OF_LINES)
  public void setNumberOfLines(DecoratedText view, int numberOfLines) {
    view.setNumberOfLines(numberOfLines);
  }

  @ReactProp(name = ViewProps.ELLIPSIZE_MODE)
  public void setEllipsizeMode(DecoratedText view, @Nullable String ellipsizeMode) {
  ...
  public void setTextAlignVertical(DecoratedText view, @Nullable String textAlignVertical) {
  ...
  public void setSelectable(DecoratedText view, boolean isSelectable) {
    view.setTextIsSelectable(isSelectable);
  }

  @ReactProp(name = "selectionColor", customType = "Color")
  public void setSelectionColor(DecoratedText view, @Nullable Integer color) {
    if (color == null) {
  ...
  public void setBorderRadius(DecoratedText view, int index, float borderRadius) {
  ...
  public void setBorderStyle(DecoratedText view, @Nullable String borderStyle) {
  ...
  public void setBorderWidth(DecoratedText view, int index, float width) {
  ...
  public void setBorderColor(DecoratedText view, int index, Integer color) {
  ...
  public void setIncludeFontPadding(DecoratedText view, boolean includepad) {
    view.setIncludeFontPadding(includepad);
  }

  @Override
  public void updateExtraData(DecoratedText view, Object extraData) {
  ...
  @Override
  protected void onAfterUpdateTransaction(DecoratedText view) {
